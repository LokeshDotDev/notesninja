	...
	return (
		<div className='w-full min-h-screen bg-gradient-to-b from-neutral-50 to-neutral-100 dark:from-neutral-900 dark:to-neutral-800 flex flex-col items-center'>
			<PageHero
				...
				description='Discover sturdy, stylish metal frame beds designed to elevate every guest experience with timeless elegance.'
			/>
			{/* <div className="w-full max-w-6xl mt-16 mb-12 px-4">
        <Featured
          categoryId="metal_frame_bed"
          label="Featured"
          highlight="Metal Frame Bed"
        />
      </div> */}
			<div className='w-full max-w-6xl mt-12 mb-24 px-4'>
				<GalleryGridSingle categoryId='metal_frame_bed' />
			</div>
		</div>
	);
};

export default MetalFrameBedPage;
