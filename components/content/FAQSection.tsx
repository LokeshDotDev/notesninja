...
const faqs = [
  ...
  },
  {
    ...
    answer: "Instant access! After payment, you'll receive a download link via email with all 6 modules in PDF format. You can download them on any device and study offline. No subscriptions or recurring payments."
  },
  {
