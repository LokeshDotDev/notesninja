...
export default function FormDialog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    files.forEach((file: File) => submitData.append("files", file));
    if (formData.isDigital && digitalFiles.length > 0) {
      digitalFiles.forEach((file: File) =>
        submitData.append("digitalFiles", file),
      );
    }
    if (initialData?.id) submitData.append("id", initialData.id.toString());

    await onSave({ id: initialData?.id?.toString(), formData: submitData });
  ...
  // Slug status indicator component
  ...
  // Slug field – rendered inside the "post" form section
  const SlugField = () => (
    <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                ...
                <p className="text-xs text-neutral-500 mb-2">
                  Select any category (including nested ones)
                </p>
                <Select
              ...
              <div>
                ...
                <div className="mt-2 border-2 border-dashed border-gray-300 rounded-lg p-4">
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-500">
                      PDF, DOCX, TXT, ZIP - Max 100MB each
                    </span>
                  </label>
                </div>
  ...
  if (triggerLabel === null) return dialogContent;
